...
class _Section18State extends State<Section18> {
  ...
  void showAd() {
    ...
    videoAd!.fullScreenContentCallback = FullScreenContentCallback(
      ...
      ad.dispose();
      updateAd(18, currentAdNum, context);
  ...
  void checkAd() {
    updateAttempt(18, currentAdNum, adCap, showAd, context);
  }

  // Back arrow logic
  void backArrow() {
    if (currentPage == 0) {
      backSection(17, context);
    } else {
      showHome = true;
      currentPage--;
      setState(() {});
          ...
          Column(
            ...
            children: [
              Header(
                ...
                opacity: 1,
                numbers: allNumber(currentPage + 119),
                homeFunc: () {

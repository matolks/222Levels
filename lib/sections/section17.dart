...
class _Section17State extends State<Section17> {
  ...
  void showAd() {
    ...
    videoAd!.fullScreenContentCallback = FullScreenContentCallback(
      ...
      ad.dispose();
      updateAd(17, currentAdNum, context);
  ...
  void checkAd() {
    updateAttempt(17, currentAdNum, adCap, showAd, context);
  }

  // Back arrow logic
  void backArrow() {
    if (currentPage == 0) {
      backSection(16, context);
    } else {
      showHome = true;
      currentPage--;
      setState(() {});
          ...
          Column(
            ...
            children: [
              Header(
                ...
                opacity: 1,
                numbers: allNumber(currentPage + 114),
                homeFunc: () {
